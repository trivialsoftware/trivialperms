...
},{"./_baseFor":24,"./keys":109}],26:[function(require,module,exports){
...
},{"./_baseMatches":36,"./_baseMatchesProperty":37,"./identity":94,"./isArray":97,"./property":113}],34:[function(require,module,exports){
...
},{"./_baseCastPath":20,"./_isIndex":68,"./_isKey":70,"./_parent":81,"./last":110}],41:[function(require,module,exports){
...
},{"./_Set":5,"./noop":112}],53:[function(require,module,exports){
...
},{"./_baseHas":27,"./keys":109}],56:[function(require,module,exports){
...
},{"./_isStrictComparable":73,"./toPairs":118}],58:[function(require,module,exports){
...
},{"./_baseCastPath":20,"./_isIndex":68,"./_isKey":70,"./_parent":81,"./isArguments":96,"./isArray":97,"./isLength":101,"./isString":105,"./last":110}],61:[function(require,module,exports){
...
},{"./toString":119}],90:[function(require,module,exports){
...
},{"./_baseIndexOf":29,"./isArrayLike":98,"./isString":105,"./toInteger":116,"./values":121}],96:[function(require,module,exports){
...
},{"./_baseHas":27,"./_baseKeys":34,"./_indexKeys":65,"./_isIndex":68,"./_isPrototype":72,"./isArrayLike":98}],110:[function(require,module,exports){
...
},{"./_arrayMap":13,"./_baseIteratee":33,"./_baseMap":35,"./isArray":97}],112:[function(require,module,exports){
...
},{"./_baseProperty":38,"./_basePropertyDeep":39,"./_isKey":70}],114:[function(require,module,exports){
...
},{"./_baseIteratee":33,"./_basePullAt":40}],115:[function(require,module,exports){
...
},{"./_arraySome":14,"./_baseIteratee":33,"./_baseSome":42,"./_isIterateeCall":69,"./isArray":97}],116:[function(require,module,exports){
...
},{"./isFunction":100,"./isObject":103}],118:[function(require,module,exports){
...
},{"./_baseToPairs":44,"./keys":109}],119:[function(require,module,exports){
...
},{"./_Symbol":8,"./isSymbol":106}],120:[function(require,module,exports){
function uniq(e){return e&&e.length?baseUniq(e):[]}var baseUniq=require("./_baseUniq");module.exports=uniq;
},{"./_baseUniq":45}],121:[function(require,module,exports){
...
},{"./_baseValues":46,"./keys":109}],122:[function(require,module,exports){
...
"use strict";function _classCallCheck(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,n){for(var i=0;i<n.length;i++){var r=n[i];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(n,i,r){return i&&e(n.prototype,i),r&&e(n,r),n}}(),find=require("lodash/find"),uniq=require("lodash/uniq"),remove=require("lodash/remove"),_={find:find,uniq:uniq,remove:remove},TPGroup=function(){function e(n,i,r){_classCallCheck(this,e),this.name=n,this.permissions=i||[],this.manager=r,this.permissions=_.uniq(this.permissions)}return _createClass(e,[{key:"hasPerm",value:function(e,n){if(1===arguments.length){var i=e.split("/");n=i[0],e=i[1]}return!!_.find(this.permissions,function(i){return"*/*"===i?!0:i.match(/^.*\/\*/)?!!i.match(new RegExp("^"+n+"/")):i.match(/^\*\/.*/)?!!i.match(new RegExp("^.*/"+e+"$")):!!i.match(new RegExp("^"+n+"/"+e+"$"))})}},{key:"addPerm",value:function(e,n){this.permissions.push(n+"/"+e),this.permissions=_.uniq(this.permissions)}},{key:"removePerm",value:function(e,n){return _.remove(this.permissions,function(i){return i===n+"/"+e})}}]),e}();module.exports=TPGroup;
},{"lodash/find":91,"lodash/remove":114,"lodash/uniq":120}],124:[function(require,module,exports){
"use strict";function _classCallCheck(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,n){for(var r=0;r<n.length;r++){var i=n[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(n,r,i){return r&&e(n.prototype,r),i&&e(n,i),n}}(),map=require("lodash/map"),find=require("lodash/find"),some=require("lodash/some"),includes=require("lodash/includes"),isFunction=require("lodash/isFunction"),isUndefined=require("lodash/isUndefined"),Promise=require("bluebird"),TPGroup=require("./group"),_={map:map,find:find,some:some,includes:includes,isFunction:isFunction,isUndefined:isUndefined},mapping={permissions:"permissions",groups:"groups"},TPManager=function(){function e(){_classCallCheck(this,e),this.groups={}}return _createClass(e,[{key:"_userHasPerm",value:function(e,n,r){return!!_.find(e[mapping.permissions],function(e){return"*/*"===e?!0:e.match(/^.*\/\*/)?!!e.match(new RegExp("^"+r+"/")):e.match(/^\*\/.*/)?!!e.match(new RegExp("^.*/"+n+"$")):!!e.match(new RegExp("^"+r+"/"+n+"$"))})}},{key:"setUserMapping",value:function(e){mapping.groups=e.groups||mapping.groups,mapping.permissions=e.permissions||mapping.permissions}},{key:"defineGroup",value:function(e){if(!e.name)throw new Error("Must specify a 'name' property.");var n=new TPGroup(e.name,e.permissions,this);return this.groups[e.name]=n,n}},{key:"loadGroups",value:function(e){var n=this,r=Promise.resolve(e);return _.isFunction(e)&&(r=e()),r.each(function(e){n.defineGroup(e)})}},{key:"hasPerm",value:function(e,n,r){var i=this;if(_.isUndefined(r)){var s=n.split("/");r=s[0],n=s[1]}var u=this._userHasPerm(e,n,r);if(!u){var a=_.map(e[mapping.groups],function(e){return i.groups[e]});u=_.some(a,function(e){return e.hasPerm(n,r)})}return u}},{key:"hasGroup",value:function(e,n){return n in this.groups&&_.includes(e[mapping.groups],n)}}]),e}();module.exports=new TPManager;
},{"./group":123,"bluebird":1,"lodash/find":91,"lodash/includes":95,"lodash/isFunction":100,"lodash/isUndefined":108,"lodash/map":111,"lodash/some":115}]},{},[124])(124)
});